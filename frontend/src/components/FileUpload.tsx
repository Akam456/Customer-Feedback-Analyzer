...
const FileUpload: React.FC<FileUploadProps> = ({ onDataUpload }) => {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div
        className={`border-2 border-solid border-gray-300 rounded-lg py-12 px-8 min-h-48 flex items-center justify-center text-center transition-all duration-300 ${
          dragActive
